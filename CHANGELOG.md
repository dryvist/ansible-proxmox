...
* **placement:** fail when a guest is not on the node the inventory records ([#751](https://github.com/dryvist/ansible-proxmox/issues/751)) ([e0dc89d](https://github.com/dryvist/ansible-proxmox/commit/e0dc89dedf8d176800587e24f1599e203c7ccc90))
...
* **docker_lxc_features:** select dashboard guests too ([#717](https://github.com/dryvist/ansible-proxmox/issues/717)) ([0d873f1](https://github.com/dryvist/ansible-proxmox/commit/0d873f1df44b9a40b8ca01877f1bf044c46b58ab))
...
* **evacuation:** add frozen host-bind copy gate ([#556](https://github.com/dryvist/ansible-proxmox/issues/556)) ([298fa19](https://github.com/dryvist/ansible-proxmox/commit/298fa19973ed6fa6b5a1b771c528977aabfc9d44))
...
* **ci:** drop unused id-token: write from ci-fix.yml ([#531](https://github.com/dryvist/ansible-proxmox/issues/531)) ([1671680](https://github.com/dryvist/ansible-proxmox/commit/1671680b20ddda0b41d0b47a7e14dfdf0d7de297))
...
* **docker_lxc_features:** cover the hindsight memory-plane replicas ([#428](https://github.com/dryvist/ansible-proxmox/issues/428)) ([c4ec07d](https://github.com/dryvist/ansible-proxmox/commit/c4ec07d5cd99bcf0ddb5ae27b76ccf0c6171bd2f))

## [1.61.0](https://github.com/dryvist/ansible-proxmox/compare/v1.60.0...v1.61.0) (2026-07-17)


### Features

* **root_authorized_keys:** manage rotatable root break-glass keys ([#429](https://github.com/dryvist/ansible-proxmox/issues/429)) ([dd7cbd5](https://github.com/dryvist/ansible-proxmox/commit/dd7cbd578c463980cf45d979cf0c8280b737a3d9))
